...
outputFiles = [
    f"SIM_{arg[0]}_{arg[1]}deg_{arg[2]}GeV_1000evt.edm4hep.root" for arg in args
]

# detectorModel = "FCCee_o1_v06"
detectorModel = "FCCee_o1_v05"
# detectorModel = "FCCee_o1_v04"
# detectorModel = "CLD_o2_v05"

job = UserJob()
job.setSplitDoNotAlterOutputFilename()
job.setName(f"DDSimSingleParticle_{detectorModel}_%n")
